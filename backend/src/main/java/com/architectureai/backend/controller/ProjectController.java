...
public class ProjectController {
    ...
    /**
     * Constructs a new {@code ProjectController} using constructor injection.
     *
    ...
    /**
     * Retrieve a single project by ID, verifying that it belongs to the authenticated user.
     *
    ...
    /**
     * Update an existing project, verifying that it belongs to the authenticated user.
     *
    ...
    /**
     * Delete a project, verifying that it belongs to the authenticated user.
     *
